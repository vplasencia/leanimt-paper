...
If the depth is 0, it can have 0 or 1 node. If it has 1 node, it is the root of the tree and if it is updated, the root is also updated because they are the same node.
...
After those cases, the tree that should be updated has depth d. Using the indictive hypothesis, the subtree of depth d will correctly update all the ancestors up to the root.
