...
One of these cases will always be seen in each level when a node is being inserted:
...
This case only happens when the node is the last node in the level and also a left node.
