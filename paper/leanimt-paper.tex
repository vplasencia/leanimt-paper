...
\begin{figure}[H]
    \centering
    \pgfplotstableread[col sep=comma]{data/insertmany-imt-leanimt-bar.csv}\datatable
    \begin{tikzpicture}
        \begin{axis}[
                ybar,
                bar width=0.5cm,
                ...
                xticklabels from table={\datatable}{Structure},
                xtick=data,
            ...
            \addplot [color=violet600, fill=violet400] table [x expr=\coordindex, y={AvgTime}, col sep=comma] {\datatable};
            \addlegendentry{Average Time}
        \end{axis}
    \end{tikzpicture}
    \caption{Batch Insertion IMT vs LeanIMT (1000 iterations)}
\end{figure}

\subsubsection{Browser}


\subsubsection{Node.js vs Browser}
